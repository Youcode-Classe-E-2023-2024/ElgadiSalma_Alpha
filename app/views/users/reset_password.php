...
<div class="antialiased bg-yellow-400 h-screen">
<div class="pt-36 ">
<div class="max-w-lg mx-auto  bg-white p-8 rounded-xl shadow shadow-slate-300">
        ...
        <form action="<?php echo URLROOT; ?>/users/resetPassword" method="post" class="my-10">
            <div class="flex flex-col space-y-5">
                ...
                <p class="text-center">Not registered yet? <a href="<?php echo URLROOT; ?>/users/register" class="text-indigo-600 font-medium inline-flex space-x-1 items-center"><span>Register now </span><span><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
